...
function program11(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n        </form>\n        <div class='response' style='display:none'>\n          <h4>Request URL</h4>\n          <div class='block request_url'></div>\n          <h4 class='request_body_info'>Request Body</h4>\n          <div class='block request_body_info request_body'><pre>Foobar</pre></div>\n          <h4>Response Body</h4>\n          <div class='block response_body'></div>\n          <h4>Response Code</h4>\n          <div class='block response_code'></div>\n          <h4>Response Headers</h4>\n          <div class='block response_headers'></div>\n        </div>\n      </div>\n    </li>\n  </ul>\n";
  return buffer;
  });
})();
...
(function() {
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.showPetStore = function(e) {
      return this.trigger('update-swagger-ui', {
        url: "http://inventory.dev/apidoc/swagger_doc.json"
      });
    };
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.showStatus = function(data) {
      ...
      console.log("Hi Pat");
      console.log(data);
      if (data.request.body && data.request.body.body) {
        $(".request_body", $(this.el)).html("<pre>" + data.request.body.body + "</pre>");
      } else {
        $(".request_body_info", $(this.el)).hide();
        $(".request_body", $(this.el)).html("<pre>n/a</pre>");
      }
